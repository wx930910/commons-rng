...
public class LongProviderTest {
	public static LongProvider mockLongProvider2(long value) {
	...
	public void testNextBoolean() {
		for (int i = 0; i < Long.SIZE; i++) {
			...
			final LongProvider provider = LongProviderTest.mockLongProvider2(value);
